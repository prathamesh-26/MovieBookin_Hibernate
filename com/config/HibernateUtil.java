	...
	public static SessionFactory getSessionFactory()
	{
		try {
			if(sf==null)
			{
				...
				map.put(Environment.JAKARTA_JDBC_URL, "jdbc:mysql://localhost:3306/moviebooking");
				...
				mds.addAnnotatedClass(Admin.class);
				mds.addAnnotatedClass(Details.class);
				mds.addAnnotatedClass(Login_Entity.class);
				mds.addAnnotatedClass(Meal.class);
